...
{
    private List<Song> _allOrders;

    public SampleDataService()
    {
    }

    private static IEnumerable<Song> AllOrders()
    {
    ...
    private static IEnumerable<Playlist> AllCompanies()
    {
    ...
    public async Task<IEnumerable<Song>> GetListDetailsDataAsync()
    {
        _allOrders ??= new List<Song>(AllOrders());

        await Task.CompletedTask;
        return _allOrders;
    }

    public async Task<IEnumerable<Song>> GetContentGridDataAsync()
    {
        _allOrders ??= new List<Song>(AllOrders());
